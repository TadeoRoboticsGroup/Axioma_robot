...
def generate_launch_description():
    ...
    # gazebo_launch_file_dir = os.path.join(get_package_share_directory('axioma_default'), 'launch')
    gazebo_launch_file_dir = os.path.join('axioma_gazebo', 'launch', 'axioma_default.launch.py')
    cartographer_launch_file_dir = os.path.join(get_package_share_directory('axioma_cartographer'), 'launch')
    nav2_launch_file_dir = os.path.join(get_package_share_directory('axioma_navigation2'), 'launch')
